...
def KitModel(weight_file = None):
    ...
    n.conv2d_1        = L.Convolution(n.input_1, kernel_h=3, kernel_w=3, stride=1, num_output=20, pad_h=1, pad_w=1, group=1,             bias_term=True, ntop=1)
    n.conv2d_1_activation = L.ReLU(n.conv2d_1, in_place=True, ntop=1)
    ...
    n.max_pooling2d_1 = L.Pooling(n.batch_normalization_1_scale, pool=0, kernel_size=2, pad_h=0, pad_w=0, stride=2, ntop=1)
    n.dropout_1       = L.Dropout(n.max_pooling2d_1, dropout_ratio=0.9700000006705523 , in_place=True, ntop=1)
    ...
    n.max_pooling2d_2 = L.Pooling(n.batch_normalization_2_scale, pool=0, kernel_h=1, kernel_w=2, pad_h=0, pad_w=0, stride=1, ntop=1)
    n.dropout_2       = L.Dropout(n.max_pooling2d_2, dropout_ratio=0.9900000002235174 , in_place=True, ntop=1)
    ...
    n.max_pooling2d_3 = L.Pooling(n.batch_normalization_3_scale, pool=0, kernel_h=1, kernel_w=2, pad_h=0, pad_w=0, stride=1, ntop=1)
    n.flatten_1       = L.Flatten(n.max_pooling2d_3)
