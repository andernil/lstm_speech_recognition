...
target_list = ['yes', 'no', 'up', 'down', 'left', 'right', 'on', 'off', 'stop', 'go', 'silence']

input_weights = sys.argv[1]

model = NetworkModels_for_CPU.RNNSpeechModel(nCategories = len(target_list), data_in_dims = (118,80,1))
