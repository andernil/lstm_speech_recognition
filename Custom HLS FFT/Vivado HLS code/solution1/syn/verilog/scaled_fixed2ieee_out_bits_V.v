...
// ==============================================================
`timescale 1 ns / 1 ps
module scaled_fixed2ieee_out_bits_V_ram (addr0, ce0, d0, we0, q0,  clk);
...
`timescale 1 ns / 1 ps
module scaled_fixed2ieee_out_bits_V(
    reset,
    clk,
    address0,
    ce0,
...
scaled_fixed2ieee_out_bits_V_ram scaled_fixed2ieee_out_bits_V_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
