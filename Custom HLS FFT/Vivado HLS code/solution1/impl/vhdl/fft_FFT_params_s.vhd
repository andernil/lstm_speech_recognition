...
entity fft_FFT_params_s is
    generic (
        INPUT_WIDTH  : integer := 64;
        OUTPUT_WIDTH : integer := 64;
        CONFIG_WIDTH : integer := 24;
...
architecture arch of fft_FFT_params_s is
    --------------------- Component ---------------------
    component fft_FFT_params_s_core is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component fft_FFT_params_s_core
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
