create_ip -vlnv xilinx.com:ip:xfft -module_name fft_FFT_params_s_core
set_property -dict [list \
    ...
    CONFIG.xk_index {0} \
] -objects [get_ips fft_FFT_params_s_core]
set_property generate_synth_checkpoint false [get_files fft_FFT_params_s_core.xci]
generate_target {synthesis simulation} [get_files fft_FFT_params_s_core.xci]
