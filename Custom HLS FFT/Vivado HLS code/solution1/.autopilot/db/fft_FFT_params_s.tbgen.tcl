...
set C_modelArgList {
	...
	{ config_ch_data_V int 24 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "xn", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "config_ch_data_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ config_ch_data_V_dout sc_in sc_lv 24 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "config_ch_data_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "config_ch_data_V", "role": "dout" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "7331", "Max" : "7331"}
]}
...
set Spec2ImplPortList { 
	...
	config_ch_data_V { ap_fifo {  { config_ch_data_V_dout fifo_data 0 24 }  { config_ch_data_V_empty_n fifo_status 0 1 }  { config_ch_data_V_read fifo_update 1 1 } } }
}
