...
set id 18
set name window_FFT_dsub_64ns_64ns_64_5_full_dsp_1
...
set id 19
set name window_FFT_dmul_64ns_64ns_64_5_max_dsp_1
...
set id 20
set name window_FFT_ddiv_64ns_64ns_64_22_1
...
set id 21
set name window_FFT_sitodp_32ns_64_4_1
...
set id 22
set name window_FFT_mul_170ns_53ns_223_2_1
...
set id 23
set name window_FFT_mux_83_1_1_1
...
set id 24
set name window_FFT_mux_164_1_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set ID 34
set hasByteEnable 0
set MemName window_FFT_ref_4oPi_table_256_V
...
set ID 35
set hasByteEnable 0
set MemName window_FFT_fourth_order_double_4
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 59
set AddrRange 256
...
set ID 36
set hasByteEnable 0
set MemName window_FFT_fourth_order_double_5
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 52
set AddrRange 256
...
set ID 37
set hasByteEnable 0
set MemName window_FFT_fourth_order_double_6
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 44
set AddrRange 256
...
set ID 38
set hasByteEnable 0
set MemName window_FFT_fourth_order_double_7
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 33
set AddrRange 256
...
set ID 39
set hasByteEnable 0
set MemName window_FFT_fourth_order_double_s
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 25
set AddrRange 256
...
set ID 40
set hasByteEnable 0
set MemName window_FFT_data_frame
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 64
set AddrRange 1024
...
# FIFO definition:
set ID 41
set FifoName fifo_w64_d1024_A_x
set InstName to_FFT_U
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 43 \
    name input_data_M_real \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename input_data_M_real \
    op interface \
    ports { input_data_M_real_address0 { O 14 vector } input_data_M_real_ce0 { O 1 bit } input_data_M_real_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_data_M_real'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { output_data_address0 { O 16 vector } output_data_ce0 { O 1 bit } output_data_we0 { O 1 bit } output_data_d0 { O 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_peak_value \
    op interface \
    ports { peak_value { I 32 vector } } \
} "
}
