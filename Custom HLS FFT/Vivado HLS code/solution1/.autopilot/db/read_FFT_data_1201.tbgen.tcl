set moduleName read_FFT_data_1201
...
set C_modelName {read_FFT_data.1201}
set C_modelType { void 0 }
set C_modelArgList {
	{ from_FFT_2 int 64 regular {fifo 0 volatile }  }
	{ from_FFT int 64 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "from_FFT_2", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ from_FFT_2_dout sc_in sc_lv 64 signal 0 } 
	{ from_FFT_2_empty_n sc_in sc_logic 1 signal 0 } 
	{ from_FFT_2_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "from_FFT_2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "from_FFT_2", "role": "dout" }} , 
 	{ "name": "from_FFT_2_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "from_FFT_2", "role": "empty_n" }} , 
 	{ "name": "from_FFT_2_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "from_FFT_2", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "from_FFT_2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	from_FFT_2 { ap_fifo {  { from_FFT_2_dout fifo_data 0 64 }  { from_FFT_2_empty_n fifo_status 0 1 }  { from_FFT_2_read fifo_update 1 1 } } }
